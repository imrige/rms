...
function areaSlideLeft(shape, animateCfg, coord) {
  ...
  var transitionPath = lastPath.slice(0, middleIndex).concat([['L', pathPatchPosX, pathPatchPosY], ['L', pathPatchPosX, updatePath[middleIndex][2]]], lastPath.slice(middleIndex));
  var v = [0, 0, 1];
  shape.apply(v);
  shape.attr('clip', clip);
  shape.attr('path', transitionPath);
